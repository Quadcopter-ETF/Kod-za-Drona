...
float pid_p_gain_yaw = 1.3;                //Gain setting for the pitch P-controller. //4.0
float pid_i_gain_yaw = 0.03 ;               //Gain setting for the pitch I-controller. //0.02
float pid_d_gain_yaw = 17;               //Gain setting for the pitch D-controller.
int pid_max_yaw = 400;                     //Maximum output of the PID-controller (+/-)

long int now_time = 9000;
...
//     // servoSignal+=inccc;
//    }
//    else if (now_time - start_time > 3000) 
servoSignal+=inccc;
      if (servoSignal > 1400){  //1400 1300 1600
      servoSignal=1400;}
    if (esc_1 < 700) esc_1 = 700;                                         //Keep the motors running.
    if (esc_2 < 700) esc_2 = 700;                                         //Keep the motors running.
    if (esc_3 < 700) esc_3 = 700;                                         //Keep the motors running.
